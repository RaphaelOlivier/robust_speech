"""
Evaluation script supporting universal adversarial attacks.
...
Example:
python universal_evaluate.py attack_configs/pgd/attack.yaml\
...
def universal_evaluate(hparams_file, run_opts, overrides):
...
if __name__ == "__main__":
    ...
    universal_evaluate(hparams_file, run_opts, overrides)
